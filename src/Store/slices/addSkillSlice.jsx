...
export const getAllSkills = () => async (dispatch) => {
  ...
  try {
    ...
    dispatch(
      skillSlice.actions.getAllSkillsSuccess(
...
export const updateSkill =
  ...
  async (dispatch) => {
    dispatch(
      skillSlice.actions.updateSkillRequest()
    );
    ...
    try {
      ...
      dispatch(
        skillSlice.actions.updateSkillSuccess(
          response.data.message
        )
      );
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    ...
    dispatch(
      skillSlice.actions.deleteSkillSuccess(
        response.data.message
      )
    );
...
export const clearAllSkillErrors =
  () => (dispatch) => {
    dispatch(
      skillSlice.actions.clearAllErrors()
    );
  };

export const resetSkillSlice =
  () => (dispatch) => {
    dispatch(
      skillSlice.actions.resetSkillSlice()
    );
  };
